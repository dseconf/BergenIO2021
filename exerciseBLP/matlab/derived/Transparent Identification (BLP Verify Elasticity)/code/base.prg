...
@ Add a few pieces of information before elasticity calculations @
del_last = y;
obj0 = obj(parm0);
delta0 = delta;
bxfinal = mean_parm_input;

x = const~(hpwt)~space~air~mpd;
...
@ Note these are only for the last year in the data @
outfile = "../output/attribute_elasticity.csv";
output file=^outfile reset;
screen off;
print "const,hpwt,space,air,mpd";
print ds;;
screen on;
output off;

outfile = "../output/price_elasticity.csv";
output file=^outfile reset;
screen off;
print "price";
print el;;
